...
from .models import Sprint_tree
from .models import Project_chosen
from .models import Test_project_setting
from .models import UI_project_setting
from .models import API_project_setting
from .models import Test_task_overview
from .models import Test_task_detail
from .models import Promble_feedback
from .models import Browser_setting
from .models import Env_setting
from .models import Database_setting
from .models import Function_setting
from .models import Operation_for_object
from .models import Assertion_type_setting
from .models import Global_variable_setting
from .models import Page_tree
from .models import UI_case_tree
from .models import API_case_tree
from .models import Page_element
from .models import UI_test_case_step
from .models import API_test_case_step
from .models import UI_test_plan
from .models import API_test_plan
from .models import Running_plan
from .models import UI_case_tree_test_plan
from .models import API_case_tree_test_plan
from .models import UI_test_report_for_summary
from .models import API_test_report_for_summary
from .models import UI_test_report_for_case
from .models import API_test_report_for_case
from .models import UI_test_report_for_case_step
from .models import API_test_report_for_case_step
