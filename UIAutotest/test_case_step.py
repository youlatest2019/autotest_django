...
class TestCaseStep:
        ...
        try:
            ...
            if self.object_type == '页面元素':
                ...
                if temp_result[0]:
                    ...
                    for run_times in range(0, self.run_times):
    ...
    def exec_system_func(self, function_name, arg=''):
        try:
            ...
            elif function_name == '切换frame':
                result = selenium_util.switch_to_frame(arg)
            elif function_name == '浏览器刷新':
                result = selenium_util.refresh_window()
            else:
