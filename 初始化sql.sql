...
insert into `website_function_setting` (`id`, `function_name`, `param_style`, `order`, `project_type`) values('11','切换frame','','11','UI项目');
insert into `website_function_setting` (`id`, `function_name`, `param_style`, `order`, `project_type`) values('12','浏览器刷新','','12','UI项目');
